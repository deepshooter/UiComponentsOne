...
/**
 * Created by Avinashmishra on 03-05-2017.
 */
...
public class HorizontalRecyclerViewAdapter extends RecyclerView.Adapter<HorizontalRecyclerViewAdapter.MyViewHolder> {
    ...
    public HorizontalRecyclerViewAdapter(Context context, List<Data> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_horizontal_recyclerview, parent, false);
        return new HorizontalRecyclerViewAdapter.MyViewHolder(itemView);
    }
