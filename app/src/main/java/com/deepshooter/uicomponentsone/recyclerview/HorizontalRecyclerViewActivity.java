...
public class HorizontalRecyclerViewActivity extends AppCompatActivity {
    ...
    RecyclerView vR_recyclerViewHorizontal ;
    ...
    {
        mTitle = getIntent().getStringExtra("horizontalrecyclerview");
        vR_recyclerViewHorizontal = (RecyclerView) findViewById(R.id.vR_recyclerViewHorizontal);
    ...
    private void setValues()
    {
        ...
        LinearLayoutManager horizontalLayoutManagaer = new LinearLayoutManager(HorizontalRecyclerViewActivity.this, LinearLayoutManager.HORIZONTAL, false);

        horizontalRecyclerViewAdapter = new HorizontalRecyclerViewAdapter(HorizontalRecyclerViewActivity.this,dataArrayList);
        vR_recyclerViewHorizontal.setLayoutManager(horizontalLayoutManagaer);
        vR_recyclerViewHorizontal.setItemAnimator(new DefaultItemAnimator());
       // vR_recyclerViewHorizontal.addItemDecoration(new SimpleDividerItemDecoration(HorizontalRecyclerViewActivity.this));
        vR_recyclerViewHorizontal.setHasFixedSize(false);

        vR_recyclerViewHorizontal.setAdapter(horizontalRecyclerViewAdapter);
